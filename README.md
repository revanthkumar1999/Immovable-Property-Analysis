# Immovable Property Sale 2001-2020 Analytics and Prediction
- [Immovable Property Sale 2001-2020 Analytics and Prediction](#real-estate-sale-2001-2020-analytics-and-prediction )
...
taking advantage of both batch and stream processing methods. Besides, we also analyze, create real-time dashboard and apply some Machine Learning models to predict the data of the Immovable Property Sale 2001-2020 records.
...
* `download_file`: It will download `Immovable Property Sales 2001-2020 GL` dataset from the website ([link download](https://data.ct.gov/api/views/5mzw-sjtu/rows.csv?accessType=DOWNLOAD)) in **csv** format and store in `data_source/` folder.
